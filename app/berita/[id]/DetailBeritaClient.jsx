...
export default function DetailBeritaClient({ berita, allBerita }) {
  const { id } = useParams();
      ...
      <nav className="bg-[var(--bg-card)] shadow-sm sticky top-0 z-50 mb-8 border-b border-[var(--border-light)]">
        <div className="max-w-7xl mx-auto px-6 py-4 flex justify-between items-center">
          ...
          <div className="flex items-center gap-4">
            <Link href="/" className="text-xs font-semibold text-[var(--text-tertiary)] hover:text-[var(--kop-blue)] transition-colors flex items-center gap-1">
