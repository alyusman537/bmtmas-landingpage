...
export async function GET() {
  try {
    ...
    return NextResponse.json({ message: 'Gagal mengambil data pembiayaan' }, { status: 500 });
  }
}
...
export async function POST(request) {
  ...
  try {
    ...
    return NextResponse.json({ message: 'Gagal menambah produk pembiayaan' }, { status: 500 });
  }
}
