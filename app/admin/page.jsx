...
import { ToggleButton } from '@/lib/ThemeContext';
      ...
      <form onSubmit={handleSubmit} className="bg-[var(--bg-card)] p-8 rounded-2xl shadow-xl border border-[var(--border-light)] w-full max-w-[450px] space-y-4">
        ...
        <div className="relative">
          <input
            ...
            className="w-full px-4 py-2 pr-10 border border-[var(--border-medium)] rounded-lg focus:outline-none focus:border-[var(--kop-blue)] bg-[var(--bg-page)] text-[var(--text-primary)] text-sm"
            autoFocus
          />
          <button
            type="button"
    ...
    <form onSubmit={handleSubmit} className="space-y-4">
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        <div>
          ...
          <input value={form.kategori} onChange={(e) => set('kategori', e.target.value)} className="w-full px-3 py-2 border border-[var(--border-medium)] rounded-lg text-[var(--text-primary)] text-sm focus:outline-none focus:border-[var(--kop-blue)]" required />
        </div>
        <div>
          <label className="block text-xs font-semibold text-[var(--text-tertiary)] mb-1">Tanggal</label>
          <input value={form.tanggal} onChange={(e) => set('tanggal', e.target.value)} className="w-full px-3 py-2 border border-[var(--border-medium)] rounded-lg text-[var(--text-primary)] text-sm focus:outline-none focus:border-[var(--kop-blue)]" required />
        </div>
      </div>
      <div>
        <label className="block text-xs font-semibold text-[var(--text-tertiary)] mb-1">Penulis</label>
        <input value={form.penulis} onChange={(e) => set('penulis', e.target.value)} className="w-full px-3 py-2 border border-[var(--border-medium)] rounded-lg text-[var(--text-primary)] text-sm focus:outline-none focus:border-[var(--kop-blue)]" required />
      </div>
      <div>
        <label className="block text-xs font-semibold text-[var(--text-tertiary)] mb-1">Judul</label>
        <input value={form.judul} onChange={(e) => set('judul', e.target.value)} className="w-full px-3 py-2 border border-[var(--border-medium)] rounded-lg text-[var(--text-primary)] text-sm focus:outline-none focus:border-[var(--kop-blue)]" required />
      </div>
      <div>
      ...
      <div>
        ...
        <textarea value={form.ringkasan} onChange={(e) => set('ringkasan', e.target.value)} rows={2} className="w-full px-3 py-2 border border-[var(--border-medium)] rounded-lg text-[var(--text-primary)] text-sm focus:outline-none focus:border-[var(--kop-blue)] resize-none" required />
      </div>
      <div>
        ...
        <textarea ref={kontenRef} value={form.konten} onChange={(e) => set('konten', e.target.value)} rows={8} placeholder="Tulis konten berita di sini...&#10;&#10;Pisahkan paragraf dengan baris kosong (enter dua kali)." className="w-full px-3 py-2 border border-[var(--border-medium)] rounded-lg text-[var(--text-primary)] text-sm focus:outline-none focus:border-[var(--kop-blue)] resize-y" required />
  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-4">
      <div>
        ...
        <input value={form.nama_produk} onChange={(e) => set('nama_produk', e.target.value)} className="w-full px-3 py-2 border border-[var(--border-medium)] rounded-lg text-[var(--text-primary)] text-sm focus:outline-none focus:border-[var(--kop-blue)]" required />
      </div>
      <div>
        ...
        <div className="space-y-2">
          {form.deskripsi.map((d, i) => (
            <div key={i} className="flex gap-2">
              <textarea value={d} onChange={(e) => setDeskripsi(i, e.target.value)} rows={2} className="flex-1 px-3 py-2 border border-[var(--border-medium)] rounded-lg text-[var(--text-primary)] text-sm focus:outline-none focus:border-[var(--kop-blue)] resize-none" required />
...
function GaleriForm({ initial, onSave, onCancel }) {
  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-4">
      <div>
        <label className="block text-xs font-semibold text-[var(--text-tertiary)] mb-1">Judul</label>
        <input value={judul} onChange={(e) => setJudul(e.target.value)} className="w-full px-3 py-2 border border-[var(--border-medium)] rounded-lg text-[var(--text-primary)] text-sm focus:outline-none focus:border-[var(--kop-blue)]" required />
      </div>
      <div>
        <label className="block text-xs font-semibold text-[var(--text-tertiary)] mb-1">Keterangan</label>
        <textarea value={keterangan} onChange={(e) => setKeterangan(e.target.value)} rows={2} className="w-full px-3 py-2 border border-[var(--border-medium)] rounded-lg text-[var(--text-primary)] text-sm focus:outline-none focus:border-[var(--kop-blue)] resize-none" />
      </div>
      <div>
